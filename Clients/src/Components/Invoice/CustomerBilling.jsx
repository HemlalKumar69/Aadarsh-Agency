        ...
        <div className="row">
          ...
          <div className="form-group col-md-6">
            ...
            <Select
              ...
              value={selectedBeat}
              onChange={(opt) => {
                setSelectedBeat(opt);         // Beat select ho gaya
                setTimeout(() => {
                  billDateRef.current?.focus(); // Bill Date input pe focus
                }, 0);
              }}
      ...
      {showSalesmanModal && (
        ...
        >
          ...
          >
            ...
            {/* 🔍 Salesman Search + Keyboard Navigation */}
            <input
              type="text"
              className="form-control mb-2"
              ...
              onKeyDown={(e) => {
                ...
                let newIndex = salesmanFocusedIndex;
                ...
                const row = document.getElementById(`salesman-row-${newIndex}`);
                if (row) {
